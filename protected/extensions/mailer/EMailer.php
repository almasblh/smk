...
class EMailer
{
    ...
    * @var string
    */
    public $pathViewsDefault = 'application.views.email';
    ...
    * @var string
    */
   public $pathLayoutsDefault = 'application.views.email.layouts';
   ...
   {
      $body = Yii::app()->controller
            ->renderPartial(
                $this->pathViews.'.'.$view,
                array_merge($vars, array('content'=>$this->_myMailer)),
                true
            );
      ...
      if ($layout === null) {
         ...
         $this->_myMailer->Body = Yii::app()->controller
                ->renderPartial(
                    $this->pathLayouts.'.'.$layout,
                    array('content'=>$body),
                    true
                );
      }
